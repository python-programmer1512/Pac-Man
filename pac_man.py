...
class map(pygame.sprite.Sprite):
    global MAP
    def __init__(self,developer,tile_size=50):
        pygame.sprite.Sprite.__init__(self)
        self.tile_size=tile_size
...
def PAC_MAN():
    ...
    while 1:
        ...
        for i in range(len(Ghosts)):
            ...
            if pygame.sprite.collide_mask(Ghosts[i][0], Player) and developer==0:
